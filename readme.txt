...
(1 - x[0]) * (1 - x[0]) + 100 * (x[1] - x[0] * x[0]) * (x[1] - x[0] * x[0])   Rosenbrock function. Answer must be in f(1, 1) = 0
x[0]*x[0]+x[1]-11)*(x[0]*x[0]+x[1]-11)+(x[0]+x[1]*x[1]-7)*(x[0]+x[1]*x[1]-7   Himmelblau function. Answer must be in f(3, 2) = 0
0.26*(x[0]*x[0]+x[1]*x[1]) - 0.48*x[0]*x[1]                                   Matyas function. Answer must be in f(0, 0) = 0